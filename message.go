...
type Message struct {
	...
	// MinimumVersion indicates the oldest protcol version that can be handled
	...
	// messages.
	// See also https://docs.cometd.org/current/reference/#_connectiontype
	// See also
	// https://docs.cometd.org/current/reference/#_bayeux_supported_connections
...
// defined in the specification. See also
// https://docs.cometd.org/current/reference/#_error
...
type Advice struct {
	...
	// to connect.
	// See also
	// https://docs.cometd.org/current/reference/#_reconnect_advice_field
	...
	// See also
	// https://docs.cometd.org/current/reference/#_timeout_advice_field
	Timeout int `json:"timeout,omitempty"`
	// Interval reprsents the minimum period of time, in milliseconds, for the
	// client to delay subsequent requests to the /meta/connect channel.
	// See also
	// https://docs.cometd.org/current/reference/#_interval_advice_field
	...
	// See also
	// https://docs.cometd.org/current/reference/#_bayeux_multiple_clients_advice
